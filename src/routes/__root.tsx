...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Smart kitchen stock. Scan, track, shop, and cook with AI." },
      { property: "og:title", content: "Restock — Your kitchen, smarter." },
      { name: "twitter:title", content: "Restock — Your kitchen, smarter." },
      { property: "og:description", content: "Smart kitchen stock. Scan, track, shop, and cook with AI." },
      { name: "twitter:description", content: "Smart kitchen stock. Scan, track, shop, and cook with AI." },
